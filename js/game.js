...
export class ConnectGame{constructor(onChange,onFinish){this.onChange=onChange;this.onFinish=onFinish;this.mode="";this.player1="Player 1";this.player2="Player 2";this.colors={R:"#ff3158",Y:"#ffd83d"};this.startingPiece="R";this.reset()}
